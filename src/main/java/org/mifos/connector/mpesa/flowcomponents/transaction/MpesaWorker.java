...
import static org.mifos.connector.mpesa.camel.routes.PaybillRoute.WORKFLOW_INSTANCE_KEY_PREFIX;
    ...
    public void setupWorkers() {
        ...
        zeebeClient.newWorker()
                ...
                .handler(((client, job) -> {
                    ...
                    redisTemplate.delete(WORKFLOW_INSTANCE_KEY_PREFIX + mpesaTxnId);
